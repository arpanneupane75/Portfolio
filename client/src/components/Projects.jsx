...
// const dummyProjects = [const dummyProjects = [
//   {
//     _id: "1",
...
//           <button className="btn btn-primary btn-lg" onClick={showMore}>
//             Show More
//           </button>
//         </div>
//       )}
  ...
  return (
    <section id="projects" className="projects-section container my-5">
      <header className="text-center mb-5">
        <h2 className="display-4 fw-bold text-gradient">My Projects</h2>
        <p className="text-muted fs-5">Some of my recent work and personal projects.</p>
      </header>
          ...
          <div key={project._id} className="col-sm-12 col-md-6 col-lg-4">
            <div className="card h-100 shadow-sm border-0 rounded-4 p-3 project-card-hover">
              ...
              <div className="d-flex gap-2 flex-wrap mt-auto">
                {project.liveUrl && (
                  <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-success d-flex align-items-center gap-1">
                    <Globe size={16} /> Live
                  </a>
                )}
                {project.githubUrl && (
                  <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-dark d-flex align-items-center gap-1">
      ...
      {visibleCount < projects.length && (
        <div className="text-center mt-4">
          <button className="btn btn-primary btn-lg" onClick={showMore}>Show More</button>
        </div>
      )}
    </section>
  );
